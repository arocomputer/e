import png from "@/assets/social.png?inline";

/**
 * ulo's share card, rendered ahead of time by `scripts/social/render.mjs` (run
 * `npm run social` after changing it). Vite inlines the PNG as a base64 data
 * URL. Served on demand because a prerendered `/social` asset has no
