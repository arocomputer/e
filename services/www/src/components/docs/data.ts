...
/**
 * The guides, as `scripts/docs/docs.mjs` produced them from arocomputer/ulo.
 *
...
/** The docs root. `scripts/docs/docs.mjs` gives this route to the home guide. */
export const HOME_ROUTE = "/docs";
