...
class SbomTests(unittest.TestCase):
    def test_workspace_selects_cli_instead_of_root_or_sdk(self):
        metadata = {'packages': [
            {'name': 'aro-e-core', 'manifest_path': '/repo/crates/core/Cargo.toml'},
            {'name': 'aro-e-sdk', 'manifest_path': '/repo/crates/sdk/Cargo.toml'},
            {'name': 'aro-e', 'manifest_path': '/repo/crates/cli/Cargo.toml'},
        ]}
    ...
    def test_root_package_remains_publishable(self):
        metadata = {'packages': [{'name': 'aro-e', 'manifest_path': '/repo/Cargo.toml'}]}
