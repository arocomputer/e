//! The terminal-free core of e: the agent turn loop, provider dialects, tools,
...
//! each other: `e_tui` (the terminal), `e_rpc` (`e rpc`), and `e_sdk` (the Rust
